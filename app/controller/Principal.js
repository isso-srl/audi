...
Ext.define('Audi.controller.Principal', {
    ...
    views:[
        ...
        'rrhh.documentos.WindowDocumentos',
        'rrhh.documentos.WindowEmisionDocumentos',
        'rrhh.rciva.WindowRciva',
        'rrhh.transacciones.WindowPrestamos',
        'rrhh.transacciones.WindowListaPrestamos'*/
    ...
    init: function() {
        this.control({
			...
			'principal headpanel[region=north] splitbutton menuitem':{
                click:this.actionButtonHeadok
            }/*,
	...
	actionButtonHeadok:function(button){
    ...
    actionButtonMenu:function(button){
        ...
        switch (button.option) {
            ...
            case 'btnMemorandum':
                var windowmemorandum = Ext.getCmp('memorandum');
                if(typeof windowmemorandum=="undefined"){
                    windowmemorandum=Ext.create('Erp.view.rrhh.documentos.WindowEmisionDocumentos',{id:'memorandum',height:430});
                    fp.add(windowmemorandum);
                    windowmemorandum.show();
                }else{
            ...
            break;
            case 'btnReasignaciones':
                var windowreasignaciones = Ext.getCmp('reasignaciones');
                if(typeof windowreasignaciones=="undefined"){
                    windowreasignaciones = Ext.create('Erp.view.rrhh.documentos.WindowEmisionDocumentos',{id: 'reasignaciones'});
                    fp.add(windowreasignaciones);
                    windowreasignaciones.show();
                }else{
                    windowreasignaciones.show();
                }
            break;
            ...
            case 'btnContratos':
                var windowcontratos =Ext.getCmp('contratos');
                if(typeof  windowcontratos=="undefined"){
                    windowcontratos = Ext.create('Erp.view.rrhh.documentos.WindowEmisionDocumentos',{id: 'contratos', height: 500,width: 820});
                    fp.add(windowcontratos);
                    windowcontratos.show();
                    
                }
                    windowcontratos.show();
            break;  

            case 'btnMaestroDocumentos':
              
                var windowmaestrodoc =Ext.getCmp('maestrodocumentos');
                if(typeof  windowmaestrodoc=="undefined"){
                    windowmaestrodoc = Ext.create('Erp.view.rrhh.documentos.WindowDocumentos',{id: 'maestrodocumentos'});
                    fp.add(windowmaestrodoc);
                    windowmaestrodoc.show();
                    
                }
                    windowmaestrodoc.show();
            break;  

            case 'btnRcivaPersonal':
               
                var windowrciva =Ext.getCmp('rciva');
                if(typeof  windowrciva=="undefined"){
                    windowrciva = Ext.create('Erp.view.rrhh.rciva.WindowRciva',{id: 'rciva'});
                    fp.add(windowrciva);
                    windowrciva.show();
            ...
            break;
            case 'btnconfrrhh':
                var WindowConfigRrhh =Ext.getCmp('configrrhh');
                if(typeof  WindowConfigRrhh=="undefined"){
                    WindowConfigRrhh = Ext.create('Erp.view.configuraciones.rrhh.WindowConfigRrhh',{id: 'configrrhh'});
                    fp.add(WindowConfigRrhh);
                    var grillaUno = WindowConfigRrhh.down('grid[option="grillaDeConfigRrhh"]');
                    grillaUno.getStore().load();
                    WindowConfigRrhh.show();

                    
                }
                    WindowConfigRrhh.show();
            break;
            case 'btnCostoSalarialtotal':
                var windowplanilla =Ext.getCmp('costosalarialtotal');
              
                if(typeof windowplanilla=="undefined" ){
                    windowplanilla=Ext.create('Erp.view.rrhh.costosalarialtotal.WindowCostoSalarialTotal',{id:'costosalarialtotal'});
                    fp.add(windowplanilla);
                    windowplanilla.show();
            ...
            break;
            case 'btnPrestamosAnticipos':
                var windowanticipos =Ext.getCmp('prestamos');
              
                if(typeof windowanticipos=="undefined" ){
                    windowanticipos=Ext.create('Erp.view.rrhh.transacciones.WindowListaPrestamos',{id:'prestamos'});
                    fp.add(windowanticipos);
                    gridlista=windowanticipos.down('gridpanel');
